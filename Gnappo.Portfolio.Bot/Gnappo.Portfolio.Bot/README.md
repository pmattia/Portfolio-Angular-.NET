...
- In a terminal, navigate to `Gnappo.Portfolio.Bot`

    ```bash
    # change into project folder
    cd Gnappo.Portfolio.Bot
    ```
...
- Run the bot from a terminal or from Visual Studio, choose option A or B.
  ...
  - Navigate to `Gnappo.Portfolio.Bot` folder
  - Select `Gnappo.Portfolio.Bot.csproj` file
